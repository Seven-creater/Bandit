...
# 为类1生成图片
def plot_class1():
    with open("/root/autodl-tmp/ai_study/bandit_study/experiments/1_basic_bandit/results.json", "r") as f:
        data = json.load(f)
    ...
    plt.suptitle("Class 1: Basic Multi-Armed Bandit", fontsize=14, fontweight='bold', y=0.995)
    plt.tight_layout()
    
    output_path = "/root/autodl-tmp/ai_study/bandit_study/experiments/1_basic_bandit/plot.png"
